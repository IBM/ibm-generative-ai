...
#   filename:  2024-05-16_openapi_schema
...
class ModelIdRetrieveResult(ApiBaseModel):
    ...
    disabled: bool
    facets: Optional[list[_ModelIdRetrieveResultFacets]] = None
    id: str
    is_live: bool
    label: str
    ...
    def model_post_init(self, __context: Any) -> None:
        ...
        if deprecated_attrs:
            ...
            for name, value in deprecated_attrs.items():
                _print_deprecation_warning(
                    "(ModerationHAP): '{name}' is deprecated! Use 'input' parameter (ModerationHAPInput) / 'output' parameter parameter (ModerationHAPOutput) instead.",
                )
...
class ModerationImplicitHate(ApiBaseModel):
    ...
    def model_post_init(self, __context: Any) -> None:
        ...
        if deprecated_attrs:
            ...
            for name, value in deprecated_attrs.items():
                _print_deprecation_warning(
                    "(ModerationImplicitHate): '{name}' is deprecated! Use 'input' parameter (ModerationImplicitHateInput) / 'output' parameter parameter (ModerationImplicitHateOutput) instead.",
                )
                setattr(self.input, name, value)
                setattr(self.output, name, value)
                delattr(self, name)
...
class ModerationStigma(ApiBaseModel):
    ...
    def model_post_init(self, __context: Any) -> None:
        ...
        if deprecated_attrs:
            ...
            for name, value in deprecated_attrs.items():
                _print_deprecation_warning(
                    "(ModerationStigma): '{name}' is deprecated! Use 'input' parameter (ModerationStigmaInput) / 'output' parameter parameter (ModerationStigmaOutput) instead.",
                )
                setattr(self.input, name, value)
                setattr(self.output, name, value)
                delattr(self, name)
...
class _BetaEvaluationCreateParametersQuery(ApiBaseModel):
    version: Literal["2023-11-22"] = "2023-11-22"


class _BetaEvaluationCreateRequest(ApiBaseModel):
    dataset_file_id: str
    description: Optional[str] = None
    experiment_id: Optional[str] = None
    field_operations: Optional[list[_BetaEvaluationCreateRequestFieldOperations]] = None
    metrics: list[str]
    model_id: Optional[str] = None
    name: str
    parameters: Optional[_BetaEvaluationCreateRequestParameters] = None
    postprocessors: Optional[list[str]] = None
    prompt_id: str
    template_id: str


class BetaEvaluationCreateResponse(ApiBaseModel):
    result: _BetaEvaluationCreateResult


class _BetaEvaluationExperimentCreateParametersQuery(ApiBaseModel):
    version: Literal["2023-11-22"] = "2023-11-22"


class _BetaEvaluationExperimentCreateRequest(ApiBaseModel):
    dataset_file_id: str
    description: Optional[str] = None
    name: str
    template_id: str
...
class BetaEvaluationExperimentCreateResponse(ApiBaseModel):
    result: _BetaEvaluationExperimentCreateResult


class _BetaEvaluationExperimentIdDeleteParametersQuery(ApiBaseModel):
    version: Literal["2023-11-22"] = "2023-11-22"


class _BetaEvaluationExperimentIdRetrieveParametersQuery(ApiBaseModel):
    version: Literal["2023-11-22"] = "2023-11-22"


class BetaEvaluationExperimentIdRetrieveResponse(ApiBaseModel):
    result: _BetaEvaluationExperimentIdRetrieveResult


class _BetaEvaluationExperimentRetrieveParametersQuery(ApiBaseModel):
    limit: Optional[int] = Field(100, ge=1, le=100)
    offset: Optional[int] = Field(0, ge=0)
    sort_by: Optional[_BetaEvaluationExperimentRetrieveRequestParamsSortBy] = None
    direction: Optional[_BetaEvaluationExperimentRetrieveRequestParamsDirection] = None
    version: Literal["2023-11-22"] = "2023-11-22"


class BetaEvaluationExperimentRetrieveResponse(ApiBaseModel):
    results: list[_BetaEvaluationExperimentRetrieveResults]
    total_count: int


class _BetaEvaluationIdDeleteParametersQuery(ApiBaseModel):
    version: Literal["2023-11-22"] = "2023-11-22"


class _BetaEvaluationIdInstanceResultRetrieveParametersQuery(ApiBaseModel):
    limit: Optional[int] = Field(100, ge=1, le=100)
    offset: Optional[int] = Field(0, ge=0)
    version: Literal["2023-11-22"] = "2023-11-22"


class BetaEvaluationIdInstanceResultRetrieveResponse(ApiBaseModel):
    results: list[_BetaEvaluationIdInstanceResultRetrieveResults]
    total_count: int


class _BetaEvaluationIdRetrieveParametersQuery(ApiBaseModel):
    version: Literal["2023-11-22"] = "2023-11-22"


class BetaEvaluationIdRetrieveResponse(ApiBaseModel):
    result: _BetaEvaluationIdRetrieveResult


class _BetaEvaluationLimitRetrieveParametersQuery(ApiBaseModel):
    version: Literal["2023-11-22"] = "2023-11-22"


class BetaEvaluationLimitRetrieveResponse(ApiBaseModel):
    result: _BetaEvaluationLimitRetrieveResult


class _BetaEvaluationPreviewCreateParametersQuery(ApiBaseModel):
    limit: Optional[int] = Field(3, ge=1, le=10)
    version: Literal["2023-11-22"] = "2023-11-22"


class _BetaEvaluationPreviewCreateRequest(ApiBaseModel):
    dataset_file_id: str
    description: Optional[str] = None
    experiment_id: Optional[str] = None
    field_operations: Optional[list[_BetaEvaluationPreviewCreateRequestFieldOperations]] = None
    metrics: list[str]
    model_id: Optional[str] = None
    name: str
    parameters: Optional[_BetaEvaluationPreviewCreateRequestParameters] = None
    postprocessors: Optional[list[str]] = None
    prompt_id: str
    template_id: str


class BetaEvaluationPreviewCreateResponse(ApiBaseModel):
    results: list[_BetaEvaluationPreviewCreateResults]
    total_count: int


class _BetaEvaluationRetrieveParametersQuery(ApiBaseModel):
    limit: Optional[int] = Field(100, ge=1, le=100)
    offset: Optional[int] = Field(0, ge=0)
    sort_by: Optional[_BetaEvaluationRetrieveRequestParamsSortBy] = None
    direction: Optional[_BetaEvaluationRetrieveRequestParamsDirection] = None
    experiment_id: Optional[str] = None
    version: Literal["2023-11-22"] = "2023-11-22"


class BetaEvaluationRetrieveResponse(ApiBaseModel):
    results: list[_BetaEvaluationRetrieveResults]
    total_count: int


class _BetaEvaluationTemplateIdRetrieveParametersQuery(ApiBaseModel):
    version: Literal["2023-11-22"] = "2023-11-22"


class BetaEvaluationTemplateIdRetrieveResponse(ApiBaseModel):
    result: _BetaEvaluationTemplateIdRetrieveResult


class _BetaEvaluationTemplateRetrieveParametersQuery(ApiBaseModel):
    version: Literal["2023-11-22"] = "2023-11-22"


class BetaEvaluationTemplateRetrieveResponse(ApiBaseModel):
    results: list[_BetaEvaluationTemplateRetrieveResults]
...
class _BetaEvaluationCreateRequestFieldOperations(ApiBaseModel):
    type: _BetaEvaluationCreateRequestFieldOperationsType


class _BetaEvaluationCreateRequestFieldOperationsType(str, Enum):
    RENAME_FIELDS = "rename_fields"
    ADD_FIELDS = "add_fields"
    SHUFFLE = "shuffle"


class _BetaEvaluationCreateRequestParameters(ApiBaseModel):
    beam_width: Optional[int] = None
    decoding_method: Optional[_BetaEvaluationCreateRequestParametersDecodingMethod] = None
    include_stop_sequence: Optional[bool] = None
    length_penalty: Optional[_BetaEvaluationCreateRequestParametersLengthPenalty] = None
    max_new_tokens: Optional[int] = None
    min_new_tokens: Optional[int] = None
    random_seed: Optional[int] = None
    repetition_penalty: Optional[float] = None
    return_options: Optional[_BetaEvaluationCreateRequestParametersReturnOptions] = None
...
class _BetaEvaluationCreateRequestParametersDecodingMethod(str, Enum):
    GREEDY = "greedy"
    SAMPLE = "sample"


class _BetaEvaluationCreateRequestParametersLengthPenalty(ApiBaseModel):
    decay_factor: Optional[float] = None
    start_index: Optional[int] = None


class _BetaEvaluationCreateRequestParametersReturnOptions(ApiBaseModel):
...
class _BetaEvaluationCreateResult(ApiBaseModel):
    created_at: AwareDatetime
    description: Optional[str] = None
    experiment_id: str
    file: Optional[_BetaEvaluationCreateResultFile] = None
    finished_at: Optional[AwareDatetime] = None
    id: str
    model_id: str
    name: str
    parameters: Optional[dict[str, Any]] = None
    prompt: _BetaEvaluationCreateResultPrompt
    result: dict[str, Any]
    started_at: Optional[AwareDatetime] = None
    status: _BetaEvaluationCreateResultStatus
...
class _BetaEvaluationCreateResultFile(ApiBaseModel):
    bytes: int
    created_at: AwareDatetime
    file_name: str
    id: str
...
class _BetaEvaluationCreateResultPrompt(ApiBaseModel):
    id: str
    input: Optional[str] = None
...
class _BetaEvaluationCreateResultStatus(str, Enum):
    PENDING = "pending"
    QUEUED = "queued"
    RUNNING = "running"
    COMPLETED = "completed"
...
class _BetaEvaluationExperimentCreateResult(ApiBaseModel):
    created_at: AwareDatetime
    description: Optional[str] = None
    evaluations_count: float
    file: Optional[_BetaEvaluationExperimentCreateResultFile] = None
    id: str
    name: str
    task: _BetaEvaluationExperimentCreateResultTask
    template_id: str


class _BetaEvaluationExperimentCreateResultFile(ApiBaseModel):
    bytes: int
    created_at: AwareDatetime
    file_name: str
    id: str
...
class _BetaEvaluationExperimentCreateResultTask(ApiBaseModel):
    id: str
    name: str
    parent_task: Optional[_BetaEvaluationExperimentCreateResultTaskParentTask] = None


class _BetaEvaluationExperimentCreateResultTaskParentTask(ApiBaseModel):
    id: str
    name: str


class _BetaEvaluationExperimentIdRetrieveResult(ApiBaseModel):
    created_at: AwareDatetime
    description: Optional[str] = None
    experiment_id: str
    file: Optional[_BetaEvaluationExperimentIdRetrieveResultFile] = None
    finished_at: Optional[AwareDatetime] = None
    id: str
    model_id: str
    name: str
    parameters: Optional[dict[str, Any]] = None
    prompt: _BetaEvaluationExperimentIdRetrieveResultPrompt
    result: dict[str, Any]
    started_at: Optional[AwareDatetime] = None
    status: _BetaEvaluationExperimentIdRetrieveResultStatus
    status_message: Optional[str] = None
    task_id: str
    template_id: str
    template_name: str
...
class _BetaEvaluationExperimentIdRetrieveResultFile(ApiBaseModel):
    bytes: int
    created_at: AwareDatetime
    file_name: str
    id: str
...
class _BetaEvaluationExperimentIdRetrieveResultPrompt(ApiBaseModel):
    id: str
    input: Optional[str] = None
    metadata: Optional[dict[str, Any]] = None
    name: str
...
class _BetaEvaluationExperimentIdRetrieveResultStatus(str, Enum):
    PENDING = "pending"
    QUEUED = "queued"
    RUNNING = "running"
    COMPLETED = "completed"
...
class _BetaEvaluationExperimentRetrieveRequestParamsDirection(str, Enum):
    ASC = "asc"
    DESC = "desc"


class _BetaEvaluationExperimentRetrieveRequestParamsSortBy(str, Enum):
    NAME = "name"
    ID = "id"
    TEMPLATE = "template"


class _BetaEvaluationExperimentRetrieveResults(ApiBaseModel):
    created_at: AwareDatetime
    description: Optional[str] = None
    evaluations_count: float
    file: Optional[_BetaEvaluationExperimentRetrieveResultsFile] = None
    id: str
    name: str
    task: _BetaEvaluationExperimentRetrieveResultsTask
    template_id: str


class _BetaEvaluationExperimentRetrieveResultsFile(ApiBaseModel):
    bytes: int
    created_at: AwareDatetime
    file_name: str
    id: str
...
class _BetaEvaluationExperimentRetrieveResultsTask(ApiBaseModel):
    id: str
    name: str
    parent_task: Optional[_BetaEvaluationExperimentRetrieveResultsTaskParentTask] = None


class _BetaEvaluationExperimentRetrieveResultsTaskParentTask(ApiBaseModel):
    id: str
    name: str


class _BetaEvaluationIdInstanceResultRetrieveResults(ApiBaseModel):
    generation_info: Optional[dict[str, Any]] = Field(None, title="Generation Info")
    score: dict[str, Any]


class _BetaEvaluationIdRetrieveResult(ApiBaseModel):
    created_at: AwareDatetime
    description: Optional[str] = None
    experiment_id: str
    file: Optional[_BetaEvaluationIdRetrieveResultFile] = None
    finished_at: Optional[AwareDatetime] = None
    id: str
    model_id: str
    name: str
    parameters: Optional[dict[str, Any]] = None
    prompt: _BetaEvaluationIdRetrieveResultPrompt
    result: dict[str, Any]
    started_at: Optional[AwareDatetime] = None
    status: _BetaEvaluationIdRetrieveResultStatus
    status_message: Optional[str] = None
    task_id: str
    template_id: str
    template_name: str
...
class _BetaEvaluationIdRetrieveResultFile(ApiBaseModel):
    bytes: int
    created_at: AwareDatetime
    file_name: str
    id: str
...
class _BetaEvaluationIdRetrieveResultPrompt(ApiBaseModel):
    id: str
    input: Optional[str] = None
    metadata: Optional[dict[str, Any]] = None
    name: str
...
class _BetaEvaluationIdRetrieveResultStatus(str, Enum):
    PENDING = "pending"
    QUEUED = "queued"
    RUNNING = "running"
    COMPLETED = "completed"
...
class _BetaEvaluationLimitRetrieveResult(ApiBaseModel):
    concurrency: _BetaEvaluationLimitRetrieveResultConcurrency


class _BetaEvaluationLimitRetrieveResultConcurrency(ApiBaseModel):
    limit: int
    remaining: int


class _BetaEvaluationPreviewCreateRequestFieldOperations(ApiBaseModel):
    type: _BetaEvaluationPreviewCreateRequestFieldOperationsType


class _BetaEvaluationPreviewCreateRequestFieldOperationsType(str, Enum):
    RENAME_FIELDS = "rename_fields"
    ADD_FIELDS = "add_fields"
    SHUFFLE = "shuffle"


class _BetaEvaluationPreviewCreateRequestParameters(ApiBaseModel):
    beam_width: Optional[int] = None
    decoding_method: Optional[_BetaEvaluationPreviewCreateRequestParametersDecodingMethod] = None
    include_stop_sequence: Optional[bool] = None
    length_penalty: Optional[_BetaEvaluationPreviewCreateRequestParametersLengthPenalty] = None
    max_new_tokens: Optional[int] = None
    min_new_tokens: Optional[int] = None
    random_seed: Optional[int] = None
    repetition_penalty: Optional[float] = None
    return_options: Optional[_BetaEvaluationPreviewCreateRequestParametersReturnOptions] = None
    stop_sequences: Optional[list[str]] = None
    temperature: Optional[float] = None
    time_limit: Optional[int] = None
    top_k: Optional[int] = None
...
class _BetaEvaluationPreviewCreateRequestParametersDecodingMethod(str, Enum):
    GREEDY = "greedy"
    SAMPLE = "sample"


class _BetaEvaluationPreviewCreateRequestParametersLengthPenalty(ApiBaseModel):
    decay_factor: Optional[float] = None
    start_index: Optional[int] = None


class _BetaEvaluationPreviewCreateRequestParametersReturnOptions(ApiBaseModel):
    generated_tokens: Optional[bool] = None
    input_parameters: Optional[bool] = None
    input_text: Optional[bool] = None
    input_tokens: Optional[bool] = None
...
class _BetaEvaluationPreviewCreateResults(ApiBaseModel):
    generation_info: Optional[dict[str, Any]] = Field(None, title="Generation Info")
    score: dict[str, Any]


class _BetaEvaluationRetrieveRequestParamsDirection(str, Enum):
    ASC = "asc"
    DESC = "desc"


class _BetaEvaluationRetrieveRequestParamsSortBy(str, Enum):
    NAME = "name"
    ID = "id"
    TEMPLATE = "template"


class _BetaEvaluationRetrieveResults(ApiBaseModel):
    created_at: AwareDatetime
    description: Optional[str] = None
    experiment_id: str
    file: Optional[_BetaEvaluationRetrieveResultsFile] = None
    finished_at: Optional[AwareDatetime] = None
    id: str
    model_id: str
    name: str
    parameters: Optional[dict[str, Any]] = None
    prompt: _BetaEvaluationRetrieveResultsPrompt
    result: dict[str, Any]
    started_at: Optional[AwareDatetime] = None
    status: _BetaEvaluationRetrieveResultsStatus
    status_message: Optional[str] = None
    task_id: str
    template_id: str
    template_name: str
...
class _BetaEvaluationRetrieveResultsFile(ApiBaseModel):
    bytes: int
    created_at: AwareDatetime
    file_name: str
    id: str
...
class _BetaEvaluationRetrieveResultsPrompt(ApiBaseModel):
    id: str
    input: Optional[str] = None
    metadata: Optional[dict[str, Any]] = None
    name: str
...
class _BetaEvaluationRetrieveResultsStatus(str, Enum):
    PENDING = "pending"
    QUEUED = "queued"
    RUNNING = "running"
    COMPLETED = "completed"
...
class _BetaEvaluationTemplateIdRetrieveResult(ApiBaseModel):
    ...
    task: Optional[_BetaEvaluationTemplateIdRetrieveResultTask] = None


class _BetaEvaluationTemplateIdRetrieveResultTask(ApiBaseModel):
    id: str
    name: str
    parent_task: Optional[_BetaEvaluationTemplateIdRetrieveResultTaskParentTask] = None


class _BetaEvaluationTemplateIdRetrieveResultTaskParentTask(ApiBaseModel):
    id: str
    name: str


class _BetaEvaluationTemplateRetrieveResults(ApiBaseModel):
    dataset_fields: dict[str, Any]
    default_prompt_ids: Optional[list[str]] = None
    id: str
    metrics: list[Union[list[Metric], Metrics]]
    name: str
    postprocessors: list[str]
    task: Optional[_BetaEvaluationTemplateRetrieveResultsTask] = None


class _BetaEvaluationTemplateRetrieveResultsTask(ApiBaseModel):
    id: str
    name: str
    parent_task: Optional[_BetaEvaluationTemplateRetrieveResultsTaskParentTask] = None


class _BetaEvaluationTemplateRetrieveResultsTaskParentTask(ApiBaseModel):
    id: str
    name: str
...
class _ModelIdRetrieveResultFacets(ApiBaseModel):
    id: str
    name: str
    type: _ModelIdRetrieveResultFacetsType


class _ModelIdRetrieveResultFacetsType(str, Enum):
    LANGUAGE = "language"
    INDUSTRY = "industry"
    MODEL_TYPE = "model_type"
...
__all__ = [
    ...
    "BaseMessage",
    "BaseTokens",
    "BetaEvaluationCreateResponse",
    "BetaEvaluationExperimentCreateResponse",
    "BetaEvaluationExperimentIdRetrieveResponse",
    "BetaEvaluationExperimentRetrieveResponse",
    "BetaEvaluationIdInstanceResultRetrieveResponse",
    "BetaEvaluationIdRetrieveResponse",
    "BetaEvaluationLimitRetrieveResponse",
    "BetaEvaluationPreviewCreateResponse",
    "BetaEvaluationRetrieveResponse",
    "BetaEvaluationTemplateIdRetrieveResponse",
    "BetaEvaluationTemplateRetrieveResponse",

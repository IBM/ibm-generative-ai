...
#   filename:  2024-01-12_openapi_schema
...
class FileRetrieveRequestParamsSortBy(str, Enum):
    NAME = "name"
...
class ModelIdRetrieveResultModelFamily(ApiBaseModel):
    id: int
    name: str
...
class RequestRetrieveRequestParamsApi(str, Enum):
    V0 = "v0"
    V1 = "v1"
    V2 = "v2"


class RequestRetrieveRequestParamsEndpoint(str, Enum):
    GENERATE = "generate"
    COMPARE = "compare"
    CHAT = "chat"


class RequestRetrieveRequestParamsOrigin(str, Enum):
    API = "api"
    UI = "ui"
...
class ApiKeyRetrieveParametersQuery(ApiBaseModel):
...
class ApiKeyRegenerateCreateParametersQuery(ApiBaseModel):
    version: Literal["2023-11-22"] = "2023-11-22"
...
class FileRetrieveParametersQuery(ApiBaseModel):
    limit: Optional[int] = Field(100, ge=1, le=100)
    offset: Optional[int] = Field(0, ge=0)
    sort_by: Optional[FileRetrieveRequestParamsSortBy] = None
...
class FileCreateParametersQuery(ApiBaseModel):
    version: Literal["2023-12-15"] = "2023-12-15"


class FileCreateRequest(ApiBaseModel):
    file: bytes
    purpose: FilePurpose


class FileIdDeleteParametersQuery(ApiBaseModel):
    version: Literal["2023-11-22"] = "2023-11-22"


class FileIdRetrieveParametersQuery(ApiBaseModel):
    version: Literal["2023-12-15"] = "2023-12-15"


class FileIdContentRetrieveParametersQuery(ApiBaseModel):
    version: Literal["2023-11-22"] = "2023-11-22"


class ModelRetrieveParametersQuery(ApiBaseModel):
    limit: Optional[int] = Field(100, ge=1, le=100)
    offset: Optional[int] = Field(0, ge=0)
    version: Literal["2023-11-22"] = "2023-11-22"


class ModelIdRetrieveParametersQuery(ApiBaseModel):
    version: Literal["2024-01-10"] = "2024-01-10"


class PromptRetrieveParametersQuery(ApiBaseModel):
    limit: Optional[int] = Field(100, ge=1, le=100)
    offset: Optional[int] = Field(0, ge=0)
    search: Optional[str] = None
...
class PromptCreateParametersQuery(ApiBaseModel):
    version: Literal["2024-01-10"] = "2024-01-10"


class PromptIdDeleteParametersQuery(ApiBaseModel):
    version: Literal["2023-11-22"] = "2023-11-22"


class PromptIdRetrieveParametersQuery(ApiBaseModel):
    version: Literal["2024-01-10"] = "2024-01-10"


class PromptIdPatchParametersQuery(ApiBaseModel):
    version: Literal["2024-01-10"] = "2024-01-10"


class PromptIdPatchRequest(ApiBaseModel):
    type: Optional[PromptType] = None


class PromptIdUpdateParametersQuery(ApiBaseModel):
    version: Literal["2024-01-10"] = "2024-01-10"


class RequestRetrieveParametersQuery(ApiBaseModel):
    limit: Optional[int] = Field(100, ge=1, le=100)
    offset: Optional[int] = Field(0, ge=0)
    status: Optional[RequestStatus] = None
    origin: Optional[RequestRetrieveRequestParamsOrigin] = None
    before: Optional[AwareDatetime] = None
    after: Optional[AwareDatetime] = None
    endpoint: Optional[Union[RequestRetrieveRequestParamsEndpoint, list[RequestRetrieveRequestParamsEndpoint]]] = None
    api: Optional[RequestRetrieveRequestParamsApi] = None
    date_: Optional[date] = Field(None, alias="date")
    version: Literal["2023-11-22"] = "2023-11-22"


class RequestChatConversationIdDeleteParametersQuery(ApiBaseModel):
    version: Literal["2023-11-22"] = "2023-11-22"


class RequestChatConversationIdRetrieveParametersQuery(ApiBaseModel):
    version: Literal["2023-11-22"] = "2023-11-22"


class RequestIdDeleteParametersQuery(ApiBaseModel):
    version: Literal["2023-11-22"] = "2023-11-22"
...
class TextChatCreateParametersQuery(ApiBaseModel):
    version: Literal["2024-01-10"] = "2024-01-10"


class TextChatOutputCreateParametersQuery(ApiBaseModel):
    version: Literal["2024-01-10"] = "2024-01-10"
...
class TextChatStreamCreateParametersQuery(ApiBaseModel):
    version: Literal["2024-01-10"] = "2024-01-10"


class TextEmbeddingCreateParametersQuery(ApiBaseModel):
    version: Literal["2023-11-22"] = "2023-11-22"
...
class TextEmbeddingCreateRequest(ApiBaseModel):
...
class TextEmbeddingLimitRetrieveParametersQuery(ApiBaseModel):
    version: Literal["2023-11-22"] = "2023-11-22"
...
class TextExtractionLimitRetrieveParametersQuery(ApiBaseModel):
    version: Literal["2023-11-22"] = "2023-11-22"


class TextGenerationCreateParametersQuery(ApiBaseModel):
    version: Literal["2024-01-10"] = "2024-01-10"


class TextGenerationComparisonCreateParametersQuery(ApiBaseModel):
    version: Literal["2023-11-22"] = "2023-11-22"


class TextGenerationLimitRetrieveParametersQuery(ApiBaseModel):
    version: Literal["2023-11-22"] = "2023-11-22"
...
class TextGenerationOutputCreateParametersQuery(ApiBaseModel):
    version: Literal["2023-11-22"] = "2023-11-22"
...
class TextGenerationIdFeedbackRetrieveParametersQuery(ApiBaseModel):
    version: Literal["2023-11-22"] = "2023-11-22"
...
class TextGenerationIdFeedbackCreateParametersQuery(ApiBaseModel):
    version: Literal["2023-11-22"] = "2023-11-22"


class TextGenerationIdFeedbackCreateRequest(ApiBaseModel):
...
class TextGenerationIdFeedbackUpdateParametersQuery(ApiBaseModel):
    version: Literal["2023-11-22"] = "2023-11-22"


class TextGenerationIdFeedbackUpdateRequest(ApiBaseModel):
    categories: Optional[list[TextGenerationFeedbackCategory]] = Field(None, min_length=1)
    comment: Optional[str] = None
...
class TextGenerationStreamCreateParametersQuery(ApiBaseModel):
    version: Literal["2024-01-10"] = "2024-01-10"


class TextModerationCreateParametersQuery(ApiBaseModel):
    version: Literal["2023-11-22"] = "2023-11-22"


class TextModerationCreateRequest(ApiBaseModel):
...
class TextTokenizationCreateParametersQuery(ApiBaseModel):
    version: Literal["2024-01-10"] = "2024-01-10"
...
class TuneRetrieveParametersQuery(ApiBaseModel):
    limit: Optional[int] = Field(100, ge=1, le=100)
    offset: Optional[int] = Field(0, ge=0)
...
class TuneCreateParametersQuery(ApiBaseModel):
    version: Literal["2023-11-22"] = "2023-11-22"


class TuneCreateRequest(ApiBaseModel):
...
class TuneImportCreateParametersQuery(ApiBaseModel):
    version: Literal["2023-11-22"] = "2023-11-22"


class TuneImportCreateRequest(ApiBaseModel):
    file_id: str
    name: str


class TuneIdDeleteParametersQuery(ApiBaseModel):
    version: Literal["2023-11-22"] = "2023-11-22"


class TuneIdRetrieveParametersQuery(ApiBaseModel):
    version: Literal["2023-11-22"] = "2023-11-22"


class TuneIdPatchParametersQuery(ApiBaseModel):
    version: Literal["2023-11-22"] = "2023-11-22"


class TuneIdPatchRequest(ApiBaseModel):
    name: Optional[str] = None
    preferred: Optional[bool] = None


class TuneIdContentTypeRetrieveParametersQuery(ApiBaseModel):
    version: Literal["2023-12-15"] = "2023-12-15"


class TuningTypeRetrieveParametersQuery(ApiBaseModel):
    version: Literal["2023-11-22"] = "2023-11-22"
...
class UserDeleteParametersQuery(ApiBaseModel):
    version: Literal["2023-11-22"] = "2023-11-22"


class UserRetrieveParametersQuery(ApiBaseModel):
    version: Literal["2023-11-22"] = "2023-11-22"


class UserPatchParametersQuery(ApiBaseModel):
    version: Literal["2023-11-22"] = "2023-11-22"


class UserPatchRequest(ApiBaseModel):
    data_usage_consent: Optional[bool] = None
    tou_accepted: Optional[bool] = None


class UserCreateParametersQuery(ApiBaseModel):
    version: Literal["2023-11-22"] = "2023-11-22"
...
class ModelIdRetrieveResult(ApiBaseModel):
    ...
    is_live: bool
    label: str
    model_family: ModelIdRetrieveResultModelFamily
    name: str
    preferred: bool
...
class PromptCreateRequest(ApiBaseModel):
...
class PromptIdUpdateRequest(ApiBaseModel):
    data: Optional[PromptTemplateData] = None
    description: Optional[str] = None
    input: Optional[str] = None
    messages: Optional[list[BaseMessage]] = None
...
class TextChatOutputCreateRequest(ApiBaseModel):
    conversation_id: Optional[str] = None
    messages: Optional[list[BaseMessage]] = Field(None, min_length=1)
    model_id: Optional[str] = None
    moderations: Optional[ModerationParameters] = None
...
class TextChatStreamCreateRequest(ApiBaseModel):
    conversation_id: Optional[str] = None
    messages: Optional[list[BaseMessage]] = Field(None, min_length=1)
    model_id: Optional[str] = None
    moderations: Optional[ModerationParameters] = None
...
class TextGenerationCreateRequest(ApiBaseModel):
    data: Optional[PromptTemplateData] = None
...
class TextGenerationOutputCreateRequest(ApiBaseModel):
    data: Optional[PromptTemplateData] = None
    input: Optional[str] = None
    model_id: Optional[str] = None
    moderations: Optional[ModerationParameters] = None
...
class TextGenerationStreamCreateRequest(ApiBaseModel):
    data: Optional[PromptTemplateData] = None
    input: Optional[str] = Field(None, examples=["How are you"], title="Input string")
    """
    The input is the prompt to generate completions, passed as a string. Note: The method tokenizes the input internally. It is recommended not to leave any trailing spaces.
...
class TextTokenizationCreateRequest(ApiBaseModel):
    data: Optional[PromptTemplateData] = None
...
class TextGenerationComparisonCreateRequest(ApiBaseModel):
